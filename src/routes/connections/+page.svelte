<script>
  ...
  const translations = {
    en: {
      ...
      subtitle: 'Visualize potential family connections based on biometric and information matching',
    ...
    es: {
      ...
      subtitle: 'Visualice las conexiones familiares potenciales basadas en coincidencias biométricas y de información',
    ...
    ar: {
      ...
      subtitle: 'تصور الاتصالات العائلية المحتملة بناءً على التطابق البيومتري والمعلوماتي',
  ...
  $: filteredConnections = connections.filter(conn => {
    ...
    if (filterLevel === 'medium' && (conn.score < 60 || conn.score >= 80)) return false;
    if (filterLevel === 'low' && (conn.score < 50 || conn.score >= 60)) return false;
          ...
          <div class="space-y-4">
            ...
            <div class="border-t pt-4">
              <div class="flex justify-between items-center mb-2">
                ...
                <span class="font-semibold" style="color: {getScoreColor(selectedNode.score)}">
                  {selectedNode.score}%
                </span>
              </div>
              ...
              <div class="flex justify-between items-center mb-2">
                ...
                <span class="text-sm text-gray-700">{selectedNode.facialScore}%</span>
              </div>
              
              <div class="flex justify-between items-center mb-2">
                <span class="text-sm text-gray-600">{t.voiceMatch}</span>
                <span class="text-sm text-gray-700">{selectedNode.voiceScore}%</span>
              </div>
              
              <div class="flex justify-between items-center mb-4">
                <span class="text-sm text-gray-600">{t.infoMatch}</span>
                <span class="text-sm text-gray-700">{selectedNode.infoScore}%</span>
              </div>
